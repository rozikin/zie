...
export const products = [
    ...
    },
    {
      ...
      name: "Logitech MX Master 2S Wireless Mouse EUse on Any Surface, Hyper-Fast Scrolling, Ergonomic Shape, Rechargeable, Control Upto 3 Apple Mac and Windows Computers, Graphite",
      description:
